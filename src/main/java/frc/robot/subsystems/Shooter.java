...
public final class Shooter extends SubsystemBase implements ActiveSubsystem {
  ...
  public static final double MAX_SHOT_DISTANCE = 3.7; // TODO: Update for hood angle
  public static final double SHOOTING_RANGE = MAX_SHOT_DISTANCE - HUB_SHOT_DISTANCE;
